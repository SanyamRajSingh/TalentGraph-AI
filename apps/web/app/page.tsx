...
import { Brain, BriefcaseBusiness, ClipboardCheck, FileText, GitBranch, Layers3, ListOrdered, Loader2, Sparkles, UserRound } from "lucide-react";
          ...
          {candidateTwin ? (
            <div className="space-y-5">
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                <Summary label="Confidence" value={`${candidateTwin.confidence}%`} />
              </div>
              <ScoreList rows={twinScores} source={candidateTwin} />
